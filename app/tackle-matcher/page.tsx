...
type RegionId = "med" | "red" | "suez" | "aqaba" | "gulf" | "gulf-oman" | "arabian-sea" | "black-sea" | "aegean";
...
export default function TackleMatcherPage(){
  ...
  const primarySea=seas[0]??"med";
  const lureRegionParam=(["med","red","suez","aqaba"] as string[]).includes(primarySea)?primarySea:"med";
